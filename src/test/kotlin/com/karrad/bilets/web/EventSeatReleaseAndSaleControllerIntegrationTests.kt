...
class EventSeatReleaseAndSaleControllerIntegrationTests {
    ...
    @Test
    fun `should release held seat over http`() {
        ...
        mockMvc.perform(
            ...
            .andExpect(jsonPath("$.seatInventory[0].status").value(SeatStatus.AVAILABLE.name))
    }

    @Test
    fun `should sell held seat over http`() {
        val event = seatedEvent()
        val layoutTemplate = seatedLayoutTemplate(requireNotNull(event.venueSpaceId))
        eventRepository.save(event)
        layoutTemplateRepository.save(layoutTemplate)
        ...
        mockMvc.perform(
            ...
            .andExpect(status().isOk)
            .andExpect(jsonPath("$.seatInventory[0].status").value(SeatStatus.SOLD.name))
    }
    ...
    private fun seatedEvent(): Event {
        return Event(
            ...
            venueId = UUID.fromString("123e4567-e89b-12d3-a456-426614174830"),
            categoryId = UUID.fromString("123e4567-e89b-12d3-a456-426614174834"),
            time = Instant.parse("2026-04-01T18:00:00Z"),
            venueSpaceId = UUID.fromString("123e4567-e89b-12d3-a456-426614174831"),
            id = UUID.fromString("123e4567-e89b-12d3-a456-426614174832")
        )
    }
    ...
    private fun seatedLayoutTemplate(venueSpaceId: UUID): LayoutTemplate {
        return LayoutTemplate(
            ...
            id = UUID.fromString("123e4567-e89b-12d3-a456-426614174833")
        )
    }
}
